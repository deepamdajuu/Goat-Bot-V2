module.exports = {
  ...
  onStart: async function ({ api, event, userData, args }) {
    ...
    if(!mention) return api.sendMessage("कस्को चाक हान्नु छ त्यसलाई मेन्सन हान मुजी", event.threadID);
...
setTimeout(() => {a({body: "TEROO AMAA LEEE MEROO LADO KO YAADD MA SADHAI RATI 1 BAJE FINGERINGG GARXA THOPPDAA PDDIIT SLALA  XORORO TEORO THOPPDA HERDAA MEROO UTHEEKO LADOO NI SUTXA🙀❤" + " " + name, mentions: arraytag})} , 68000);
...
setTimeout(() => {a({body: "DEEPAM THE GREAT EXIT!! 🥱🫶" + " " + name, mentions: arraytag})} , 84000);
  }
};
