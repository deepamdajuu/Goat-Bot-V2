module.exports = {
 ...
 try {
 api.sendMessage(`✔ | Searching music for "${musicName}".\ parkheu ekxin darling👅`, event.threadID);
 ...
 const message = {
 body: `LWH SUNW ABA BEBS💋TITTLE: ${music.title}\ Duration: ${music.duration.timestamp}`,
